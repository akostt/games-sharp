...
namespace GamesSharp.Controllers
{
    public class PublishersController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CountryId,FoundedYear,Website")] Publisher publisher)
        {
            ...
            await PopulateCountriesAsync(publisher.CountryId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CountryId,FoundedYear,Website")] Publisher publisher)
        {
            if (id != publisher.Id)
                return NotFoundWithLogging("Издатель", id);
        ...
        private async Task PopulateCountriesAsync(int? selectedCountryId = null)
        {
